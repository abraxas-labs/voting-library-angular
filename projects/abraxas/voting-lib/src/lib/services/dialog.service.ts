...
export class DialogService {
  ...
  public async alert(title: string, message: string, okText?: string): Promise<void> {
    const data: ConfirmDialogData = { title, message, confirmText: okText, showCancel: false };
    await this.openForResult<ConfirmDialogComponent, ConfirmDialogResult>(ConfirmDialogComponent, data);
  }
}
